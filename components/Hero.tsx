...
const Hero = () => {
    ...
    return (
        <div className="bg-white text-white dark:bg-black">
            <section className="bg-animated cyber-grid py-40 lg:py-52 flex flex-col items-center justify-center p-4">
                <div id="particles"></div>
                <div className="text-center">
                    <h1 className="text-6xl font-bold mb-4 text-neon dark:text-white neon-text glitch-effect hover-3d" data-text="LINK-BITE">
                        LINK-BITE
                    </h1>
